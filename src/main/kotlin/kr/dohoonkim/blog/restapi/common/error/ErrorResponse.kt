...
class ErrorResponse {
    ...
    companion object {
        ...
        fun of(code : ErrorCode, violations : Set<ConstraintViolation<*>>) = ErrorResponse(code, FieldError.of(violations))
    ...
    class FieldError(val field : String,
                     val value : String,
                     val reason : String) {
        companion object {
            ...
            fun of(bindingResult : BindingResult) : List<FieldError> {
                ...
                return fieldErrors.stream().map { FieldError(it.field,
