...
class AuthenticationController(
    ...
    @ApiResponses(value = [
        ...
        ApiResponse(responseCode = "401", description = "A001 - 로그인 실패<br/>", content = [Content(schema = Schema(implementation=ErrorResponse::class))])
    ])
    ...
    @ApiResponses(value = [
        ...
        ApiResponse(responseCode = "401", description = "J001 - 잘못된 토큰<br/>J002 - 만료된 리프레시 토큰<br/>J003 - 잘못된 인증 헤더",
