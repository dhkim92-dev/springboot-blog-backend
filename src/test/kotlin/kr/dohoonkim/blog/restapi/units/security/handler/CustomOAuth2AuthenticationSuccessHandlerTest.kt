...
internal class CustomOAuth2AuthenticationSuccessHandlerTest: AnnotationSpec() {
    ...
    private lateinit var claims: JwtClaims
    ...
    fun setUp() {
        ...
        handler = CustomOAuth2AuthenticationSuccessHandler(jwtService, customUserDetailService, objectMapper)
    }
